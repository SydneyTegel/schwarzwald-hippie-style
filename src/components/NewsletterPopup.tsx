          ...
          >
            ...
            <div className="bg-gradient-to-br from-primary/20 to-accent/10 px-8 pt-8 pb-6 text-center">
              ...
              <p className="text-muted-foreground text-sm mt-2">
                ...
                <span className="text-accent font-semibold"> 10 % auf deine erste Bestellung</span>.
              </p>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-background border border-border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all text-sm"
                    />
                  </div>
                  <button
                    type="submit"
                  ...
                  <p className="text-[11px] text-muted-foreground text-center">
                    Kein Spam. Jederzeit abbestellbar. Nur das Beste aus dem Schwarzwald.
                  </p>
                </form>
              ) : (
                <div className="text-center py-4">
                  <div className="text-3xl mb-2">🎉</div>
                  <p className="text-foreground font-semibold">Willkommen im Wald!</p>
                  <p className="text-muted-foreground text-sm mt-1">
                    Dein Rabattcode ist unterwegs.
                  </p>
                </div>
              )}
            </div>
